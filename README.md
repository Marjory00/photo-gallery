# Ionic App : Photo Gallery
Ionic Angular and Capacitor

Build a photo-gallery app that runs on iOS, Android, and the web. Follow along to create a complete CRUD (create-read-update-delete) experience.

For more info: ["Your First App: Angular" guide](https://ionicframework.com/docs/angular/your-first-app).
